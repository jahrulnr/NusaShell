...
var o = class {
	...
	observeCall(e) {
		...
		if (t && this.onClassChange && this.onClassChange(this.select.className.split(" ")), n && this.onDisabledChange && (this.changeListen(!1), this.onDisabledChange(this.select.disabled), this.changeListen(!0)), r && this.onOptionsChange) {
			if (this.isUpdating) {
				...
				i && this.select.dispatchEvent(new (globalThis.window?.Event ?? Event)("change"));
				return;
			}
	...
	updateOptions(e) {
		if (!(!e || e.length === 0)) {
			...
			if (this.select.dispatchEvent(new (globalThis.window?.Event ?? Event)("change", { bubbles: !0 })), this.changeListen(!0), this.isUpdating = !1, this.pendingOptionsChange !== null) {
