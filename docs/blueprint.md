...
- Right-click → context menu: **Open, Start, Force Stop, Restart, Details, Uninstall**; editable fields get **Cut / Copy / Paste**
- Search bar filters installed plugins by name, ID, or manifest description
