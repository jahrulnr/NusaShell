...
func TestRosterUniqueness(t *testing.T) {
	methods := []string{
		...
		MethodSkillsFileRead, MethodSkillsInstall, MethodSkillsPromote, MethodSkillsRollback,
		...
		MethodMemoryList, MethodMemorySearch, MethodMemoryGet, MethodMemoryRetire,
		MethodMemoryUserUpdate, MethodMemoryAgentUpdate,
		MethodExperienceList, MethodExperienceGet,
		MethodLearningSearch, MethodLearningGraph, MethodLearningLog, MethodLearningJobsList, MethodLearningJobsStatus,
		...
		MethodAutomationRunsStart, MethodAutomationRunsList, MethodAutomationRunsGet, MethodAutomationRunsCancel, MethodAutomationRunsRetry,
		MethodAutomationJobsGet, MethodAutomationJobsLogs, MethodAutomationJobsCancel, MethodAutomationArtifactsList,
		MethodAutomationRunnersList, MethodAutomationCacheList, MethodAutomationCacheClear,
		...
		MethodAutomationSchedules, MethodAutomationCapabilities, MethodAutomationProviderDisable,
	...
	events := []string{
		...
		EventAutomationRunCancelled, EventAutomationRunWaiting, EventAutomationRunBlocked,
		EventAutomationJobQueued, EventAutomationJobStarted, EventAutomationJobCompleted, EventAutomationJobFailed,
