...
func TestRosterUniqueness(t *testing.T) {
	methods := []string{
		...
		MethodCIList, MethodCIGet, MethodCISave, MethodCIDelete,
		MethodCIEnable, MethodCIDisable, MethodCIRun, MethodCIValidate,
		MethodCIEvents, MethodCIIngest, MethodCIDependents,
		MethodCISchedules, MethodCICapabilities, MethodCIProviderDisable,
