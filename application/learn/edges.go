// Package learn — learning edge builder.
//
...
func (b *EdgeBuilder) SetUserStore(user DocumentStore) {
	if b == nil {
		return
	}
	b.buildMu.Lock()
...
func retrievableRecords(store RecordStore, limit int) []*domain.MemoryRecord {
	if store == nil {
		return nil
	}
