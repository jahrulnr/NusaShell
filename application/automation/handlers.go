...
func (a *App) handleAutomation(ctx context.Context, method string, payload json.RawMessage) (any, *contracts.RPCError) {
	...
	case contracts.MethodAutomationRunsStart:
		var req contracts.AutomationRunStartRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
		if req.ID == "" {
	...
	case contracts.MethodAutomationRunsGet:
		var req contracts.AutomationRunIDRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
		...
		return runDTO(run), nil
	case contracts.MethodAutomationRunsCancel:
		var req contracts.AutomationRunIDRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
		...
		return runDTO(run), nil
	case contracts.MethodAutomationRunsSteer:
		var req contracts.AutomationRunSteerRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
	...
	case contracts.MethodAutomationJobsLogs:
		var req contracts.AutomationLogsRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
		limit := req.Limit
	...
	case contracts.MethodAutomationJobsGet:
		var req contracts.AutomationLogsRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
		...
		return jr, nil
	case contracts.MethodAutomationJobsCancel:
		var req contracts.AutomationRunIDRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
	...
	case contracts.MethodAutomationCacheList:
		return map[string]any{"entries": []any{}}, nil
	case contracts.MethodAutomationCacheClear:
		return map[string]bool{"ok": true}, nil
	case contracts.MethodAutomationRunnersList:
	...
	case contracts.MethodAutomationGet:
		var req contracts.AutomationWorkflowIDRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
	...
	case contracts.MethodAutomationSave:
		var req contracts.AutomationWorkflowSaveRequest
		if err := contracts.DecodePayload(payload, &req); err != nil {
			return nil, err
		}
	...
	case contracts.MethodAutomationProviderDisable:
		...
		return map[string]bool{"ok": true}, nil
	default:
		return nil, &contracts.RPCError{Code: contracts.CodeValidation, Message: "unknown automation method"}
	}
}
