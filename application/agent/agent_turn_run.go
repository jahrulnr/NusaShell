...
func (a *Service) RunTurn(run *TurnRun, provider *domain.Provider, apiKey, model, effort, asstMsgID string, initialContinuation bool, caps ModelCapabilities) {
	run.InitTurnDiff()
...
func (a *Service) RunTurnChain(run *TurnRun, provider *domain.Provider, apiKey, model, effort, asstMsgID string, initialContinuation bool, caps ModelCapabilities, autoContinueIndex int) {
	chainModel := model
	chainEffort := effort
...
func (a *Service) ApplyQueuedSteer(run *TurnRun) (bool, error) {
...
func (a *Service) ApplyQueuedRunResults(run *TurnRun) (bool, error) {
...
func (a *Service) applyRunDoneList(conversationID string, pending []PendingRunDone) (int, error) {
	applied := 0
