...
// learnerPrompt is the background learner system prompt. The model uses a
// pruned toolbox plus learn() for typed catalog commits, the same way
// compaction commits a handoff with summary().
