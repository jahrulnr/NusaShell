...
type ThinkingMapper func(*core.Thinking, string) (map[string]any, error)
type CapabilityMapper func(model string, base core.Capabilities) core.Capabilities
type HeaderMapper func(http.Header, *core.Request)
type ResponseFormatMapper func(*core.ResponseFormat) (any, error)
type SchemaMapper func(core.Schema, core.StrictMode) (any, error)
type ProviderOptionsMapper func(core.ProviderOptions, map[string]any, *core.Request) error
type WarningMapper func(*core.Request) []core.Warning
type MessageMapper func([]core.Message) (any, error)
type ToolMapper func([]core.Tool) (any, error)
