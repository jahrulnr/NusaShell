...
import (
	...
	"nusashell/domain"
	"nusashell/infrastructure/acp/client"
)
...
func TestReadTextFileBypassReadsOutsideWorkspace(t *testing.T) {
	...
	res, err := pc.ReadTextFile(context.Background(), client.ReadTextFileParams{
...
func TestWriteTextFileBypassWritesOutsideWorkspace(t *testing.T) {
	...
	if err := pc.WriteTextFile(context.Background(), client.WriteTextFileParams{
		SessionID: "sess_bypass",
		Path:      outsideFile,
...
func TestReadTextFileEditConfirmedRejectedOutside(t *testing.T) {
	...
	_, err := pc.ReadTextFile(context.Background(), client.ReadTextFileParams{
		SessionID: "sess_edit",
		Path:      outsideFile,
	})
	if err == nil {
...
func TestWriteTextFileBypassTerminalRunFailsClosed_Write(t *testing.T) {
	...
	err := pc.WriteTextFile(context.Background(), client.WriteTextFileParams{
		SessionID: "sess_bypass_done",
		Path:      outsideFile,
