...
- For this NusaShell conversation, also note: which plugins are currently running, which tools (if any) were already granted this session, the current active UI view if relevant, and any pending plugin installations or settings changes
